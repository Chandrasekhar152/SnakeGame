...
class Apple:
    ...
    def move(self):
        self.x = random.randint(1, 900 // SIZE - 1) * SIZE
        self.y = random.randint(1, 700 // SIZE - 1) * SIZE
...
class Game:
    ...
    def display_score(self):
        ...
        self.surface.blit(score, (500, 16))
    ...
    def play(self):
        ...
        # collision with wall
        if (self.snake.x[0] < 0 or self.snake.x[0] >= 900 or
            self.snake.y[0] < 0 or self.snake.y[0] >= 700):
